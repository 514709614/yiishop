    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd none">
                ...
                <?php
                include Yii::getAlias('@web').'/category.php';
                ?>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><?=\yii\bootstrap\Html::a(\yii\bootstrap\Html::img('http://otfagnmwi.bkt.clouddn.com/'.$model->logo),['index/goods','id'=>$model->id])?></dt>
                        <dd><?=\yii\bootstrap\Html::a($model->name,['index/goods','id'=>$model->id])?></dt>
