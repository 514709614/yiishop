<?php
include Yii::getAlias('@web').'/header.php';
?>
<!-- 头部 start -->
            ...
            <div class="preview fl">
                ...
                <div class="midpic">
                    <a href="http://admin.yiishop.com.<?=$model->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=\yii\bootstrap\Html::img('http://otfagnmwi.bkt.clouddn.com/'.$model->logo,['width'=>'175px','height'=>'175px','style'=>'opacity:1;'])?>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                        ...
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: '<?='http://admin.yiishop.com'.$model->logo?>',largeimage: '<?='http://admin.yiishop.com'.$model->logo?>'}">
                                    <img src="<?='http://admin.yiishop.com'.$model->logo?>">
                                </a>
                            </li>
                        </ul>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <?php
                    $obj=\frontend\models\GoodsIntro::findOne(['goods_id'=>$model->id]);
                    echo $obj->content;
                    ?>
                </div>
                <!-- 商品介绍 end -->
...
<?php
include Yii::getAlias('@web').'/footer.php';
?>